...
(function (SHA) {
    ...
    SHA.prototype = {
        ...
        _array : function() {
            var i, _tmp, _result = [], _limit = Math.floor(this._outBit / 32), _length = this._hash.length;
            switch (this._bit) {
                case 160:
                case 256:
